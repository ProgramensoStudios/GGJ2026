...
public class PostProcessChange : MonoBehaviour
{
    ...
    [Header("Lift Gamma Gain - NONE")] //
    [SerializeField] private Vector4 noneGamma = new Vector4(0f, 0f, 0f, -0.18f);
    [SerializeField] private Vector4 noneGain  = new Vector4(0f, 0f, 0f, 0.73f);
